// Generated from runtime/alpha3/compat/session-persistence-jsonl/src/index.ts; edit the TypeScript source.
/**
...
import { createSessionFormatCatalogWithChildren, SessionFormatUnsupportedMigrationError, sessionFormatCatalog, } from 'dsh-nexttavern-session-format/catalog';
...
class JsonlSessionPersistence extends SessionPersistence {
    ...
    name = 'nexttavern-session-persistence-jsonl';
    root;
    compression;
    rootEncodingCheck;
