...
} from 'dsh-nexttavern-session-format/catalog'
...
import { JsonlBackendTracker, JsonlSessionHandle, type StorageHandleState } from './storage.js'
...
class JsonlSessionPersistence extends SessionPersistence {
  ...
  override readonly name = 'nexttavern-session-persistence-jsonl'
  ...
  private async prepareStoredMigration(
    ...
    const events = prepared.artifact.events as unknown as SessionEvent[]
