...
import type { CacheRetention, ChatTemplateKwargValue, ModelThinkingLevel, Provider, ThinkingBudgets, Transport } from 'dsh-nexttavern-pi-ai'
...
import type { ProviderSpec } from './provider.js'
...
export function resolveProfiles(
  ...
  for (const [provider, source] of entries) {
    ...
    resolved.set(provider, {
      ...
      piProvider: buildProvider(providerSpec),
    })
  }
  return resolved
}
