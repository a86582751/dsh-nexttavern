// Generated from runtime/alpha3/compat/ui-chat/src/client/conversation-nodes/turn-navigation.ts; edit the TypeScript source.
...
export function turnNavigationItem(turn, locations, nodes) {
    const loaded = locations.getTurn(turn)
        ...
        .filter((node) => node !== undefined && isVisibleChatNode(node));
