// Generated from runtime/alpha3/compat/ui-chat/src/client/chat/message-chrome.ts; edit the TypeScript source.
 ...
 */
export function formatLiveRunDuration(ms, t) {
    const totalSeconds = Math.max(0, Math.floor(ms / 1000));
    const hours = Math.floor(totalSeconds / 3600);
    const minutes = Math.floor(totalSeconds / 60) % 60;
    const seconds = String(totalSeconds % 60);
    if (hours > 0)
        return t('duration.hours', { hours, minutes: pad2(minutes), seconds });
    return minutes > 0
