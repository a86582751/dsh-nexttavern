// Generated from runtime/alpha3/compat/session-controller/src/index.ts; edit the TypeScript source.
...
let SessionController = (() => {
    ...
    return class SessionController extends _classSuper {
        ...
        forkPrepared(request, beforePublish) {
            if (typeof beforePublish !== 'function')
                throw new TypeError('forkPrepared requires a reservation callback');
