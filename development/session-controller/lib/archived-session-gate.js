// Generated from runtime/alpha3/compat/session-controller/src/archived-session-gate.ts; edit the TypeScript source.
/**
...
export function underArchivedSession(ctx, agent) {
    ...
    while (!visited.has(header.id)) {
        if (archived.includes(header.id))
            return true;
        ...
        if (parent === undefined)
            return archived.includes(header.parentSession);
