...
import type { SessionJob as JobView } from '../../types.js'
import type { SessionProjectionMap } from '@deepseek-ai/dsh-session-projection/types'
import {
  createSnapshotStore, notifySubscribers, type ObservableSnapshot, type SnapshotStore,
} from '@deepseek-ai/dsh-client-store'
import type { RemoteFailure, RemoteResult } from '@deepseek-ai/dsh-typert-protocol'
import type { SessionEventSource } from '../contract/events.js'
import type { SessionFace } from '../contract/session.js'
import type {
  AgentContext, ISessions, SessionReference, SessionRetainInfo, SessionRetainOptions, SessionTarget,
} from '../contract/sessions.js'
import type { SessionReferenceSource } from '../index.js'
import { createScope, scopeIdentityOf, scopeOf as scopeTagOf } from '../scope.js'
import { SessionManager } from './manager.js'
import type { SessionRemotes } from './remotes.js'
import type { SessionListPhase, SessionSearchResultItem, SubagentCatalogSnapshot } from './manager.js'
