...
export function apply(ctx: Context): void {
  ...
  const flowSource = (hole: 'sidebar.workspaces.presentation' | 'sidebar.workspaces.directoryFlow' | 'conversation.hero.workspace.directoryFlow'): HostObservable<boolean> => ({
