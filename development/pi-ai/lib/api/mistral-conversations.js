// Generated from runtime/alpha3/compat/pi-ai/src/api/mistral-conversations.ts; edit the TypeScript source.
...
async function consumeChatStream(model, output, stream, mistralStream) {
    ...
    for (const index of toolBlocksByKey.values()) {
        const block = output.content[index]; // Each map entry records an earlier content push.
