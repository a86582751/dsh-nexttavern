// Generated from runtime/alpha3/compat/pi-ai/src/api/google-generative-ai.ts; edit the TypeScript source.
    ...
    (async () => {
        ...
        try {
            ...
            for await (const chunk of googleStream) {
                ...
                // Final usage may follow the terminal candidate on a relay-held stream.
                if (output.rawStopReason && Number.isFinite(chunk.usageMetadata?.totalTokenCount))
                    break;
            }
            if (currentBlock) {
                if (currentBlock.type === "text") {
