// Generated from runtime/alpha3/core/tavern-library-input.ts; edit the TypeScript source.
...
export const safeLibraryType = (value) => {
    if (typeof value !== 'string' || !/^[a-z]+\/[a-z0-9!#$&^_.+-]+(?:;\s*charset=(?:utf-8|us-ascii))?$/i.test(value) || value.length > 128)
...
export const libraryObjectName = (sha256, name) => `${sha256}--${safeLibraryName(name)}`;
