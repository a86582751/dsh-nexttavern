...
import { bootstrapBundledPackages, inspectBundledPackages, isWriterLockBusy } from './bundled-package-bootstrap.mjs';
...
export function createOwnedPackagePreparation(facts) {
    return createPackagePreparation({
        ...
        prepare: async () => {
            ...
            if (referencesCurrent(preparedVersions(facts), bundle.version, names))
