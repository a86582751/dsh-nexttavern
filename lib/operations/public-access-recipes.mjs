// Generated from runtime/alpha3/src/operations/public-access-recipes.mts; edit the TypeScript source.
export function adaptPublicAccess(source, recipe) {
    ...
    if (recipe === 'remote-settings') {
        ...
        throw Error('Unknown public-access recipe');
    if (source.split(before).length !== 2)
        throw Error('Public-access adaptation anchor changed: ' + recipe);
