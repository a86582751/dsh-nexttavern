// Generated from runtime/alpha3/src/ui/status-surface.ts; edit the TypeScript source.
import { createDecisionSeat } from './decision-seat.js';
...
export function createStatusSurface({ React, createRoot, resolveActiveSessionId, isRoleplaySession, useTavernActivity, BackgroundNotesBanner, fetchState, stateVersion, subscribeState, invalidateState, applyImmersive, readImmersive, runMaintenance, toast }) {
    ...
    function StatusOverlay({ sessionId }) {
        ...
        const visiblePoint = (point, margin = 40) => point
        ...
        if (!activeSessionId || !isRoleplaySession(activeSessionId)
            || (!currentState && !loading && !initialSessionLoading))
            return null;
