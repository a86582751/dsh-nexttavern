// Generated from runtime/alpha3/src/ui/conversation-presentation.ts; edit the TypeScript source.
...
export function createConversationPresentation({ React, sessionsService, toast, errorMessage }) {
    ...
    function TavernWorkspacePresentation({ browserProps, renderDefault }) {
        ...
        if (!catalog.value)
            ...
            }, catalog.error ?? '正在读取酒馆会话…', catalog.error
