// Generated from runtime/alpha3/src/ui/pricing-panel.ts; edit the TypeScript source.
...
export function createPricePanel({ React, sessionDrafts, jsonFetch, toast, statTime, errorMessage }) {
    function PricePanel({ sessionId, models, onSaved }) {
        ...
        return React.createElement('fieldset', {
            ...
            className: 'dsh-rp-muted'
        }, `来源：${catalog.source ?? '未同步'} · ${catalog.fetchedAt ? statTime(catalog.fetchedAt) : '尚无更新时间'} · ${catalog.count ?? entries.length ?? 0} 项`), catalog.stale ? React.createElement('div', {
