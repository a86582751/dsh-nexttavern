...
import {testTempRoot as tmpdir, createTestDirectory,cleanupTestDirectory} from '../tools/test-temp.mjs'
import {join} from 'node:path'
import { apply } from '../preset/lib/roleplay-core.js'
import { internalTaskSeqs, InlinePending } from '../src/core/tavern-tasks.js'
import { inlineTaskInstruction } from '../src/core/tavern-task-context.js'
import { recordSha256, rollLogEntries, stableImportId } from '../src/core/roleplay-data.js'
import { registerAvatarRoute } from '../src/core/roleplay-panel-routes.js'
import { registerMaintenanceRoute } from '../src/core/roleplay-job-routes.js'
