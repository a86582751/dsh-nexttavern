// Generated from runtime/alpha3/operations/install-public.mts; edit the TypeScript source.
        ...
        if (member.path.endsWith('/agent.cordis.yml')) {
            ...
            for (const id of ['anydoc', 'dsh-office']) {
                ...
                if (!options.documents)
                    ...
                    doc.contents.items[index].set('name', modulePath(id === 'anydoc' ? 'dsh-plugin-anydoc' : '@huiliyi37/dsh-office'));
            }
